namespace DrivingSchoolWebApp.Services.Models.School
{
    ...
    public class EditSchoolInputModel : IMapFrom<School>,IHaveCustomMappings
    {
        ...
        {
            configuration.CreateMap<EditSchoolInputModel, School>()
                .ForMember(dest => dest.ManagerId, x => x.Ignore())
